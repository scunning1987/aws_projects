...
openssl req -new -newkey rsa:4096 -days 0 -nodes -x509 -subj "/C=US/ST=Denial/L=Springfield/O=Dis/CN=www.streamer.com" -keyout /etc/ssl/private/streamer.key  -out /etc/ssl/private/streamer.cert
